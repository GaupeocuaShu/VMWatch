...
const ProductDetail = () => {
    ...
    // Watch that same gender
    const {
        watches: sameGenderWatches,
        loading: sameGenderLoading,
        error: sameGenderError,
    } = useFetchWatches({
        type: watch?.gender,
        key: "",
        limit: 4,
        ...
        <>
            <Box margin={matches ? "20px 200px" : "20px 20px"}>
                <Helmet>
                    ...
                    <meta
                        name="description"
                        content={watch?.meta_description}
                    />
                </Helmet>
                    ...
                    <Accordion>
                        ...
                        <AccordionDetails>
                            <ul>
                                ...
                                <li>
                                    Express delivery within 2 hours in: Ho Chi
                                    Minh City, Hanoi, Bien Hoa, Vung Tau, Binh
                                    Duong, Da Nang.
                                </li>
                                <li>
                                    Delivery to suburban areas: 2-3 days (may
                                    take up to 7 days depending on the region).
                                </li>
                            </ul>
                        </AccordionDetails>
                    </Accordion>
            ...
            <Box mt={4}>
                {sameGenderLoading ? (
                    ...
                    <Error errorMessage={sameGenderError} />
                ) : (
                    <WatchList
                        watches={sameGenderWatches}
