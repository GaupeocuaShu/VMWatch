...
const Brand = () => {
                ...
                return (
                    <Box textAlign="center">
                        <Button
                            ...
                            component={Link}
                            to={`/admin/watch-collection/${id}/edit`}
                        >
                            Edit
                        </Button>
                        <Button
                            ...
                            color="error"
                            size="small"
                            onClick={() => handleDeleteWatchCollection(id)}
                        >
                            Delete
                        </Button>
                    </Box>
    ...
    // Handle Delete
    const handleDeleteWatchCollection = async (id) => {
        setIsLoading(true);
        //Show alert
    ...
    // Fetch Brand
    const fetchWatchCollection = async () => {
        await axiosClient
            .get("api/watch-collections")
            .then(({ data }) => {
                setWatchCollections(data.data);
                setIsLoading(false);
            })
    ...
    return (
        <Box m="20px" height="100%">
            <Header
                ...
                subtitle="Managing Watch Collection"
